package com.hydracontrolfreak.hcf.timeRanges;
...
public class TimeSpec {
	...
	private List<com.hydracontrolfreak.hcf.timeRanges.TimeRange> times;
...
//			System.out.println("within: There are no times specified, returning false");
		...
		for (com.hydracontrolfreak.hcf.timeRanges.TimeRange timeRange : times) {
...
//		System.out.println("within: don't match anything returning false");
	...
	public List<com.hydracontrolfreak.hcf.timeRanges.TimeRange> getTimes() {
		return times;
	}

	public void setTimes(List<com.hydracontrolfreak.hcf.timeRanges.TimeRange> times) {
		this.times = times;
	}
...
//		System.out.println("\nIn parseTimeSpecs, node: " + node);
		...
		for (int specIndex = 0; specIndex < timeSpecList.getLength(); specIndex++) {
			...
			List<com.hydracontrolfreak.hcf.timeRanges.TimeRange> timeRanges = new ArrayList<com.hydracontrolfreak.hcf.timeRanges.TimeRange>();
