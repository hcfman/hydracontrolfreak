...
public class HandleRemoteCamFetch implements Runnable {
	...
	public HandleRemoteCamFetch(final HcfDeviceConfig hcfConfig, final VideoType videoType,
	...
	private void handleFetch(final RemoteCameraSpec remoteCameraSpec) {
		...
		final FreakDevice freakDevice = hcfConfig.getFreakConfig().getFreakMap()
		...
		sb.append(freakDevice.getProtocol().toString().toLowerCase()).append("://")
				...
				.append(freakDevice.getPort()).append("/hcf/");
