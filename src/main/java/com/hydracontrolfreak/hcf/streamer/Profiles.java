...
import com.hydracontrolfreak.hcf.hcfdevice.config.ProfileConfig;
import com.hydracontrolfreak.hcf.hcfdevice.configImpl.ProfileImpl;
...
//		freak = Freak.getInstance();
	...
	protected void service(HttpServletRequest request,
		...
		if (request.getMethod().equals("POST")) {
			...
			hcfConfig.setProfileConfig(newProfileConfig);
