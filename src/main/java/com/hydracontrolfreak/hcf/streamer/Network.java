...
//		freak = Freak.getInstance();
	...
	private void changeNetworkSettings(NetworkJSON networkJSON) {
		...
		ScriptRunnerResult scriptRunnerResult = scriptRunner.spawn(
				...
				freak.getHcfBase() + "/bin/setnetwork.sh",
				"setnetwork.sh",
				Boolean.toString(networkJSON.isDhcp()),
				networkJSON.getHostname(),
				networkJSON.getAddress(),
				networkJSON.getMask(),
				networkJSON.getDefaultRoute(),
				networkJSON.getNameServer1() == null ? "" : networkJSON
						.getNameServer1(),
				networkJSON.getNameServer2() == null ? "" : networkJSON
						.getNameServer2(),
				networkJSON.getNameServer3() == null ? "" : networkJSON
						.getNameServer3());
	}
