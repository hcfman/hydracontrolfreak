	...
	private void changeDateTime(String year, String month, String day,
		...
		synchronized (freak) {
			try {
				...
				opLogger.info("Changing date/time");
				ScriptRunner scriptRunner = new ScriptRunner();
				ScriptRunnerResult scriptRunnerResult = scriptRunner
						.spawn(freak.getHcfBase() + "/bin/suwrapper",
								freak.getHcfBase() + "/bin/setdatetime.sh",
								"setdatetime.sh",
								Boolean.toString(dateTimeJSON.isUseNtp()),
								year, month, day,
								Integer.toString(dateTimeJSON.getTimeHour()),
								Integer.toString(dateTimeJSON.getTimeMinute()),
								dateTimeJSON.getNtpServer(),
								dateTimeJSON.getTimeZone());
			} finally {
				freak.mountReadonly();
			}
		}
