...
import com.hydracontrolfreak.hcf.json.ImportCertJSON;
...
//		freak = Freak.getInstance();
	...
	private ImportCertJSON importIt(ImportCertJSON importCertJSON)
		...
		CertInstaller certInstaller = new CertInstaller(freak, hcfConfig,
				freak.getHcfBase() + "/tmp");
		if (logger.isDebugEnabled())
			logger.debug("Call importCert");
		certInstaller.importCert(true, "hcf", importCertJSON.getContent());
