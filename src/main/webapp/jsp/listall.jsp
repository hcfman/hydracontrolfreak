<%@ page import="java.util.HashMap,com.hydracontrolfreak.hcf.json.ViewJSON,com.hydracontrolfreak.hcf.hcfdevice.configImpl.VideoType,java.util.TreeMap,org.apache.log4j.Logger,java.util.List,java.util.Map,java.util.SortedSet,java.util.Date,java.text.SimpleDateFormat,com.hydracontrolfreak.hcf.hcfdevice.config.CameraDevice" %>
...
<head>
    ...
    <script type="text/javascript" src="js/hcf.js"></script>
</head>
<body>
...
<div id="top-header">
	...
	<img alt="Hydra Control Freak" src="images/hcf-title.jpg">
...
<div id="main">
	<table id="trigger-events">
		...
		<tbody>
		<%
		// http://localhost:8081/hcf/webm/1/2011-02-20/1298231417694.htm
