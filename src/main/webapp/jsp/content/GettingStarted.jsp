...
<div id="getting-started">
	...
	<div class="white">
		<p>Your HydraControlFreak works by process input events triggered by devices such as X10 PIR sensors (by means of a CM15PRO x10 controller),
		PIR sensors from other manufacturers (by means of a "Phidget interface card), user-defined
		buttons from your smart phone, other HydraControlFreaks (HCF's) and by scheduled calendar events. The events all have a name associated with them that you
		...
		<li>Trigger video on another HCF (Remote video)</li>
	...
	into your HCF. Then click on the "System Status" page and it should show up green to indicate that it is connected. It should then be ready to turn on/off devices
	...
	<p>
	If you intend to record video, then you will need a sd-disk. Note: You insert this disk upside down into the HCF. i.e. if you are looking down onto the HCF's logo then you insert
	...
	the disk is present but it's not formatted for HCF. Go to the Maintenance page now and press format. Note: This can take a very long time in the case of a large
	...
	can click on "View image" in the browser and see the url. It is often something like /video.mjpg. Set whether or not you want a guest HCF to be able to view it and
	...
	for your information only. Select whether or not a guest freak is allowed to use this button (A guest freak is defined as an HCF whose rights are selected as "guest"
