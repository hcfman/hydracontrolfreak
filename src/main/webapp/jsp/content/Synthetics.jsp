		...
		<table class="wrapper">
			<tbody>
				<tr>
					...
					<input type="button" name="Add Synthetic" onclick="JSDialog.openDialog('/hcf/jsp/content/forms/synthetic-new.html', this, null, {buttonName:'Save'})" value="Add Combination Events">
