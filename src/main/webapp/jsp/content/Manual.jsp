...
<div id="manual-content">
	...
	<div class="white">
		...
		<dl>
			...
			<dd>The prefix to use in urls. By default this is set to
				...
				the HCF itself but not if this url is present in an SMS alert or
				...
				changes the webprefix in the event that you have to access your HCF
	...
	<div class="white">
		...
		<p>The rfxtrx433 device is a very convenient device as it
			...
			and GENERIC OUTPUT descriptors Hydra Control Freak can receive events
		...
		<dl>
			...
			<dd>This is a number that a sender may increment to keep track
				...
				the Rfxtrx433 device. When using Hydra Control Freak, we ignore this
